...
GLuint _shader::GetAttributeHandle(int num, const char* name)
{
...
void _shader::SetUniform1f(int num, const char* name, float x)
{
#ifndef DISABLE_SHADERS
	GLuint thndl = 0;
...
void _shader::SetUniform3f(int num, const char* name, float x, float y, float z)
{
#ifndef DISABLE_SHADERS
	GLuint thndl = 0;
	thndl = glGetUniformLocation(shaders[num]->program, name);
...
void _shader::SetUniform4f(int num, const char* name, float x, float y, float z, float w)
{
#ifndef DISABLE_SHADERS
	GLuint thndl = 0;
	thndl = glGetUniformLocation(shaders[num]->program, name);
...
void _shader::SetUniform1i(int num, const char* name, int x)
{
	SetUniform1i(shaders[num], name, x);
}

void _shader::SetUniform1i(Shader *shader, const char* name, int x)
{
#ifndef DISABLE_SHADERS
	GLuint thndl = 0;
...
void _shader::SetUniformMatrix3fv(int num, const char* name, _matrix mt)
{
#ifndef DISABLE_SHADERS
	GLuint thndl = 0;
...
void _shader::SetUniformMatrix4fv(int num, const char* name, float *mt)
{
	SetUniformMatrix4fv(shaders[num], name, mt);
}

void _shader::SetUniformMatrix4fv(Shader *shader, const char* name, float *mt)
{
#ifndef DISABLE_SHADERS
	GLuint thndl = 0;
	thndl = glGetUniformLocation(shader->program, name);
...
void _shader::SetAttribute4f(int num, const char* name, float x, float y, float z, float w)
{
#ifndef DISABLE_SHADERS
	GLuint thndl = 0;
	float t[4];
...
uint8 _shader::Add(char *vs, char *fs, char *name)
{
	...
	else
	{
		...
		fprintf(stderr, "l2mapper shader error: %s\n", info);
	}
