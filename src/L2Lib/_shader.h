...
public:
	...
	void Disable();
	GLuint GetAttributeHandle(int num, const char* name);
	void SetUniform1f(int num, const char* name, float x);
	void SetUniform3f(int num, const char* name, float x, float y, float z);
	void SetUniform4f(int num, const char* name, float x, float y, float z, float w);
	void SetUniform1i(int num, const char* name, int x);
	void SetUniform1i(Shader *shader, const char* name, int x);
	void SetUniformMatrix3fv(int num, const char* name, _matrix mt);
	void SetUniformMatrix4fv(int num, const char* name, float *mt);
	void SetUniformMatrix4fv(Shader *shader, const char* name, float *mt);
	void SetAttribute3f(GLuint hndl, float x, float y, float z);
	void SetAttribute4f(int num, const char* name, float x, float y, float z, float w);
